...
function load_jschart_override_options() {
    ...
    if (imported_options.threshold_invalidate !== undefined) {
	if (imported_options.threshold_invalidate === "true" || imported_options.threshold_invalidate === "TRUE") {
	    loaded_options.threshold_invalidate = true;
	} else {
	    loaded_options.threshold_invalidate = false;
	}
	console.log("Found override: threshold_invalidate=%s", loaded_options.threshold_invalidate);
    }
...
function parse_plot_file(chart, datasets_index, text) {
	...
	if (jschart_override_options.threshold_invalidate !== undefined &&
	    jschart_override_options.threshold_invalidate) {
